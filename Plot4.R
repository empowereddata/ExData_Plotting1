### JHU_DataScience_Exploratory_Data_Analysis_Course_Project_1_Plot2

## 1. Reading, naming and subsetting power consumption data
power <- read.table("household_power_consumption.txt",skip=1,sep=";")
names(power) <- c("Date","Time","Global_active_power","Global_reactive_power","Voltage","Global_intensity","Sub_metering_1","Sub_metering_2","Sub_metering_3")
subpower <- subset(power,power$Date=="1/2/2007" | power$Date =="2/2/2007")

## 2. Transforming the Date and Time vars from characters into objects of type Date and POSIXlt respectively
...
## 3. Initiating a composite plot with many graphs
par(mfrow=c(2,2))

## 4. Displaying 4 plots with respective functions
with(subpower,{
